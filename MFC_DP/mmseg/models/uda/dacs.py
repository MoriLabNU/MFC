...
class DACS(UDADecorator):
    ...
    def __init__(self, **cfg):
        ...
        self.mix = cfg['mix']
        self.enable_mixing = self.mix is not None
        self.blur = cfg['blur']
        ...
        self.mfc = MaskingConsistencyModule(cfg=cfg)
    ...
    def update_debug_state(self):
        if self.debug_img_interval and self.local_iter % self.debug_img_interval == 0:
    ...
    def forward_train(self,
        ...
        if self.enable_masking:
            masked_loss = self.mfc(self.get_model(), img, img_metas,
                                   gt_semantic_seg, target_img,
                                   target_img_metas, valid_pseudo_mask,
                                   pseudo_label, pseudo_weight)
            masked_loss = add_prefix(masked_loss, 'mfc_loss')
